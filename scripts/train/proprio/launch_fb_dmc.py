...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.train.proprio.launch_fb_dmc --use_wandb --wandb_gname fb_walker_proprio --data_path ../exorl_state  --workdir_root results/fbwalker0 --sweep_config sweep_walker
    uv run -m scripts.train.proprio.launch_fb_dmc --use_wandb --wandb_gname fb_cheetah_proprio --data_path ../exorl_state  --workdir_root results --sweep_config sweep_cheetah
